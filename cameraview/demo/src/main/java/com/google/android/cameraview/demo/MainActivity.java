...
public class MainActivity extends AppCompatActivity implements
        ...
        AspectRatioFragment.Listener, RecognitionListener {

    private static final String TAG = "MainActivity";

    private SpeechRecognizer speech = null;
    private Intent recognizerIntent;
    public BackgroundVoiceListener backgroundVoiceListener;
    ...
    private int FIX_WIDTH = 468, FIX_HEIGHT = 624; //FATOR 0.15 ESCALA
    ...
    private void permissionToWrite(){
    ...
    private void permissionToSpeech(){
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        switch (requestCode) {
            ...
            case REQUEST_WRITE_PERMISSION:
                ...
                if (grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(this, R.string.write_storage_permission_not_granted,
                            Toast.LENGTH_SHORT).show();
                }
                System.out.println("Permission Speech Before");
                permissionToSpeech();
                // No need to start camera here; it is handled by onResume
                break;

            case REQUEST_RECORD_PERMISSION:
                System.out.println("Permission Speech After");
        ...
        public void onPictureTaken(CameraView cameraView, final byte[] data) {
            ...
            getBackgroundHandler().post(new Runnable() {
                ...
                public void run() {
                    ...
                    Log.d(TAG, "Local Saved: " + Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES));
                    ...
                    try {
                        ...
                        Bitmap resized = Bitmap.createScaledBitmap(bitmap, FIX_WIDTH, FIX_HEIGHT, true);
...
/*******************************************************/
    ...
    private static String VOICE_KEY = "cena";
    @Override
    ...
    public void speechResult(ArrayList resultList){
    ...
    public void setListening(boolean bol){
        listening = bol;
    }
